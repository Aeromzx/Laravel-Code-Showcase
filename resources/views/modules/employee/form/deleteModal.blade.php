<div class="ui deleteEmployee tiny modal" style="border-radius: 130px!important;" id="createNewEmployeeModal">
    <div class="header">Wirklich Löschen</div>
    <div class="scrolling content">

        @csrf
        <div style="text-align: center">
            <h1 class="text-gray-800 text-xl">Möchtest du den Mittarbeiter Wirklich löschen?</h1>
